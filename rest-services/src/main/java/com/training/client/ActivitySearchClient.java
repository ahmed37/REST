...
public class ActivitySearchClient {
	...
	public List<Activity> search(String param, List<String> searchValues, String secondParam, int durationFrom,
		...
		URI uri = UriBuilder.fromUri("http://localhost:8080/rest-services/webapi").path("search/activities")
	...
	public List<Activity> search(ActivitySearch search) {
		...
		URI uri = UriBuilder.fromUri("http://localhost:8080/rest-services/webapi").path("search/activities").build();
